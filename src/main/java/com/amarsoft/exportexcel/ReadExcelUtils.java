...
public class ReadExcelUtils {
     ...
     */
    public static List<List<String>> readExcel(String filepath, Integer sheetNo)
        ...
        if (workbook != null) {
            if (sheetNo == null) {
                ...
                for (int i = 0; i < numberOfSheets; i++) {
                    ...
                    alllist.addAll(readExcelSheet(sheet));
                }
            } else {
...
//                            sb.append(cell.getStringCellValue() + " ");
                            list.add(getValue(cell)==null?"":getValue(cell));
                        }else{
                            list.add("");
                        }
                    }
...
//                cellValue = df.format(cell.getNumericCellValue());
    ...
    public static void main(String[] args) throws IOException, InvalidFormatException {
        List<List<String>> lists = readExcel("C:\\Users\\mjwang\\Desktop\\STK_BANK_BALA=====1\\STK_BANK_BALA.xlsx", 0);
